...
My aim is to look at the transcripts of Dating on the Spectrum, the Netflix series, and Love is Blind, a show about dating with individuals who are not on the Spectrum. For the purpose of this project, we are asking if there are differences in language among Autistic adults and Adults who are typically developed? If so, what are these differences and what domains are these differences in?
