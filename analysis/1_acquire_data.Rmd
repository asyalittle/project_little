...
### Usage
I will directly download the files from opensubtitles.org and then decompress its contents into the `data/original/` directory. I will use the `target_dir` command in order to download and decompress the data. **(I am a little confused on if this is really the steps I need to take in order to upload my data to the original folder in my project... could use some help here)**
