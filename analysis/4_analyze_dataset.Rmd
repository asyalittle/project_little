...
```{r}
read_csv(file = "../data/derived/love_is_blind/love_is_blind_curated_data_dictionary.csv")
```
...
```{r}
# make datasets in the same corpus
```
...
lots_keywords <-
  lots_dfm %>% # dfm
  dfm_trim(min_docfreq = 2) %>% # keep terms appearing in 2 or more episodes
  textstat_keyness() # compare to Love Is Blind
```
