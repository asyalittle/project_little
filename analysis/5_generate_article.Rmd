...
We will investigate two Netflix series, *Love on the Spectrum* and *Love is Blind* and see if we see these common lexical differences in those on the spectrum.

It is important to note that the two shows are not exactly the same. While *Love on the Spectrum* 
## Background
