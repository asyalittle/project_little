...
We did further investigation on whether or not we see echolalia in individuals on the spectrum by focusing on the Type-Token Ratio. Our plot (which is found in the analyze portion of this website) shows that participants in *Love on the Spectrum* had more diversity in their lexicon, which is contrary to what we hypothesized. Instead, we believed that the individuals on *Love on the Spectrum* used more common and basic words and that there would be more repetition in their transcripts. Instead, we found that the *Love is Blind* has more repetition and *Love on the Spectrum* is more diverse and has more words.
